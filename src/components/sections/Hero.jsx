    ...
    <section id="home" className="min-h-screen h-screen relative overflow-hidden flex items-center justify-center">
      ...
      >
        <motion.div variants={textVariants} className="mb-6">
          <span className={`inline-block px-4 py-2 backdrop-blur-sm rounded-full text-sm border mb-6 ${isDark
        ...
        >
          <TypewriterEffect
            ...
            className={`text-5xl md:text-7xl font-bold ${isDark
        ...
        <motion.p
          variants={textVariants}
          className={`text-xl md:text-2xl mb-8 max-w-2xl mx-auto leading-relaxed transition-colors duration-500 ${isDark
        ...
        >
          ...
          <a href="https://drive.google.com/file/d/1Uya-cOzeJnksnvcIa9X0f_bd8BNOBmGW/view?usp=sharing" download>
            <Button
              variant="secondary"
              size="lg"
              className={`backdrop-blur-sm transition-colors duration-300 ${isDark
        ...
        >
          {[
            ...
            { icon: Linkedin, href: "https://www.linkedin.com/in/sourabh-agarwall/", label: "LinkedIn" },
            { icon: Mail, href: "mailto:sourabh.agarwal2023@vitstudent.ac.in", label: "Email" }
          ].map(({ icon: Icon, href, label }) => (
            <motion.a
              key={label}
              href={href}
              className={`p-3 backdrop-blur-sm rounded-full border transition-all duration-300 ${isDark
